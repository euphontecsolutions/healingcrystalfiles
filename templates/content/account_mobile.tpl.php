...
?>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents" style="text-decoration: none;">
...
<div class="container"  >
  <h3><?php echo tep_date_short($orders['date_purchased']); ?></h3>
...
echo '<a href="' . tep_href_link('account_history_info_mobile.php', 'order_id=' . $orders['orders_id'], 'SSL') . '">' . tep_template_image_button('small_view.gif', SMALL_IMAGE_BUTTON_VIEW) . '</a>   '  . '<a href="' . tep_href_link('order_comments_mobile.php','order_id=' . $orders['orders_id'], 'SSL') . '">' . tep_template_image_button($comment_image, $comment_alt) . '</a>';  ?>
</div>			
 <tr>
