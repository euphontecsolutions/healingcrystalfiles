...
function editEntry(entryId){
    var url = 'checkout_confirmation_mobile.php?action=getData&addId='+entryId; 
...
function get_all_zone(countryId){
    var url = 'checkout_confirmation_mobile.php?action=getzone&cId='+countryId;
    $.post(url, function(data) {
        if (data != 'no zone'){
            $('#stateData').html(data);
        }
...
function setDefault(){
    ...
    var url = 'checkout_confirmation_mobile.php?action=udateSendto&addId='+selAddId;
    $.post(url, function(data) {
        if(data == 'success'){
...
function processData(){
    ...
    if(error == false){
        var url = 'checkout_confirmation_mobile.php?action=processData&addId='+addId+'&fname='+fname+'&lname='+lname+'&add1='+add1+'&add2='+add2+'&pocode='+pocode+'&city='+city+'&state='+state+'&country='+country;
        $.post(url, function(data) {
...
function showShippingMethod(sendto){
    var url = 'checkout_confirmation_mobile.php?action=showShipping&sendto='+sendto;
    $.post(url, function(data) {
       ...
       <tr>
		...
		<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<td align="center" width="25%">
						<table border="0" width="100%" cellspacing="0" cellpadding="0">
              				...
              				<tr>
              					...
              					<td><?php echo tep_draw_separator('pixel_silver.gif', '1', '5'); ?></td>              					

                				<td width="50%" align="left"><?php echo tep_draw_separator('pixel_silver.gif', '100%', '1'); ?></td>
				...
				<tr>         
					<td align="center" width="25%" class="checkoutBarFrom">Login/Signup<br/>Step 1</td>
		            <td align="center" width="20%" class="checkoutBarFrom"><a href="<?php echo tep_href_link('shopping_cart.php');?>" class="checkoutBarFrom">Select Products<br/>Step 2</a></td>	
		            <?php
           ...
           if (!tep_session_is_registered('paypal_ec_token') && !tep_session_is_registered('paypal_ec_payer_id') && !tep_session_is_registered('paypal_ec_payer_info')) { ?>
            		...
            		<td align="center" width="25%" class="checkoutBarFrom"><?php echo '<a href="' . tep_href_link(FILENAME_CHECKOUT_PAYMENT, '', 'SSL') . '" class="checkoutBarFrom">' . CHECKOUT_BAR_PAYMENT . '<br/>Step 3</a>'; ?></td>

            <?php } else { ?>

            		<td align="center" width="25%" class="checkoutBarFrom"><?php echo CHECKOUT_BAR_PAYMENT ; ?><br/>Step 3</td>

            <?php } ?>

		            <td align="center" width="25%" class="checkoutBarCurrent">Review Order<br/>Step 4</td>
...
?>
                ...
                <td align="left" id="processpayment" class="processpayment">
                ...
                <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?><img src="images/ajax-loader.gif" id="loadingimage" alt="Processing Order" width="1" height="1"></td>
...
<tr><td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td></tr>
      <tr><td class="main" style="font-size:15px;"><br><b><i>If you are experiencing any errors on our website or if you are having problems checking out, please <a class="main" href="<?php echo tep_href_link('checkout_problems.php');?>" class="main"><u>Let Us Know</u></a>.</i></b></td></tr>
</table>
<div id="blanket">
    <div id="blanketDiv"> 
        ...
        <div style="width:96%; padding:20px; overflow-x: hidden; overflow-y: scroll; max-height: 550px;">
            <div id="address_list">
                            ...
                            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                              <tr>
                                ...
                                <td align="right" width="50%" valign="top"><table border="0" cellspacing="0" cellpadding="2">
                                  <tr>
                                    <td class="main" align="center" valign="top"><b><?php echo 'Default Shipping Address'; ?></b><br><?php echo tep_image(DIR_WS_IMAGES . 'arrow_south_east.gif'); ?></td>
                                    <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                                    <td class="main" valign="top"><?php echo tep_address_label($customer_id, $customer_default_shipping_id, true, ' ', '<br>'); ?></td>
                                    <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                                  </tr>
                                </table></td>
                              </tr>
                    ...
                    <tr>
                        <td class="main">        
                            ...
                            <?php if (tep_count_customer_address_book_entries() < MAX_ADDRESS_BOOK_ENTRIES) { ?>								                
                                    <td class="smallText" align="left"><?php echo '<a href="#" onclick="addNewEntry(); return false;">' . tep_template_image_button('button_add_address.gif', IMAGE_BUTTON_ADD_ADDRESS) . '</a>'; ?></td>
                            <?php } ?>        	
                                </tr>        
                            </table>         
                        </td>
                            ...
                            <td width="100%">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td align="right" nowrap><?php echo '&nbsp;&nbsp;<a href="#" onclick="editEntry(\''.$addresses['address_book_id'].'\'); return false;">' . tep_template_image_button('small_edit.gif', SMALL_IMAGE_BUTTON_EDIT) . '</a>&nbsp;&nbsp;'; ?></td>
                                        <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                                    </tr>
                                    <tr>
                                        <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
        ...
        $radio_buttons++;
            ...
            <div id="address_fields">
                <table  width="100%" cellspacing="0" cellpading="0" id="address_details">
                    <tr><td><?php echo tep_draw_hidden_field('addId','0').tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td></tr>
                    ...
                    <tr>
                        <td><?php echo tep_draw_hidden_field('addId','0').tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
                    </tr>
