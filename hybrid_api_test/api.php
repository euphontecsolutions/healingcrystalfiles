...
//Properties
			        ...
			        //	echo	$stone_name_query = "select stone_name, stone_name_id from stone_names where `detailed_mpd`= '".$category_id."' order by stone_name_id ASC";die();
			        $stone_name_query = "select stone_name, stone_name_id from stone_names where `detailed_mpd`= '".$category_id."' order by stone_name_id ASC";
$no_of_stones = $conn->query($stone_name_query);
	$stone_name_ids2 = array();
		while($stone_name_ids_new = $no_of_stones->fetch_assoc()){		    
...
echo '<pre>'; print_r($pro_final_string);die();
die();
//END of properties
			...
			if($slider==7){
				if($category_level==1){
					...
					$categoryArr['data']	= array();
						...
						$cat1=array('category_id'=>'M','slider'=>7,'category_level'=>2,'category_name'=>'Monthly Newsletter Archive','component'=>'products');
